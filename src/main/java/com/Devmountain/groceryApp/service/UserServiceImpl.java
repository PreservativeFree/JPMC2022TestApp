...
@Service //it's strange, but you can add @Service outside the class and not get penalized by the compiler
public class UserServiceImpl implements UserService {
    ...
    public List<String> addUser(UserDto userDto) {
        ...
        if(savedUser != null)
            ...
            response.add("User Added command failed"); //I haven't seen this, but it is supposed to gracefully handle an error by giving you a print Statement and a Blank WhiteLabel Http message
        return response;
    }
